  ...
  return (
    <>
      ...
      <motion.header
        ...
        animate={{
          background: scrolled
            ? "rgba(255,249,201,0.97)"
            : "rgba(255,249,201,0.9)",
                  ...
                  {isActive && (
                    <motion.span
                      ...
                      style={{
                        ...
                        height: 2,
                        background: "linear-gradient(90deg, var(--teal), #7de8f0)",
                        borderRadius: 1,
                      }}
                    />
                  )}
        ...
        {menuOpen && (
          <motion.div
            ...
            style={{
              ...
              background: "linear-gradient(160deg, #fff9c9, #fffde0)",
              borderTop: "1px solid rgba(2,185,201,0.2)",
              overflow: "hidden",
            }}
          >
