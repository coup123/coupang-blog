...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        {/* 배경 블롭 */}
        <div className="hero-blob" style={{ width: 500, height: 500, background: "rgba(2,185,201,0.12)", top: -100, right: -100 }} />
        <div className="hero-blob" style={{ width: 350, height: 350, background: "rgba(2,185,201,0.07)", bottom: -60, left: "30%" }} />
        <div className="hero-blob animate-float" style={{ width: 200, height: 200, background: "rgba(2,185,201,0.1)", top: "40%", right: "20%", animationDelay: "1s" }} />
        ...
        <div className="container" style={{ position: "relative" }}>
          ...
          <Reveal variant="fadeUp" delay={0.2}>
            <div
              ...
              style={{ borderTop: "1px solid rgba(2,185,201,0.25)" }}
            >
              {[
                { num: "9+", label: "큐레이션 꿀팁" },
                { num: "3", label: "생활 카테고리" },
      ...
      {latestPosts.length > 0 && (
        <section
          style={{
            background: "linear-gradient(180deg, #02b9c9 0%, #017585 100%)",
            paddingTop: 80,
            paddingBottom: 80,
          }}
        >
      ...
      {Object.values(CATEGORIES).map((cat, idx) => {
        ...
        return (
          <section
            ...
            style={{
              background: isDark
                ? "linear-gradient(160deg, #02b9c9 0%, #017585 100%)"
                : "linear-gradient(160deg, #ffffff 0%, #fff9c9 100%)",
              paddingTop: 80,
              paddingBottom: 80,
              borderTop: isDark ? "none" : "1px solid rgba(2,185,201,0.15)",
            }}
          >
            <div className="container">
              <Reveal variant="fadeUp">
