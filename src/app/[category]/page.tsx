...
export default async function CategoryPage({ params }: Props) {
  ...
  return (
    <>
      ...
      <section
        style={{
          background: "linear-gradient(160deg, #1a2e16 0%, #111111 60%, #0e1a0b 100%)",
          paddingTop: 80,
          paddingBottom: 80,
          position: "relative",
          overflow: "hidden",
      ...
      >
        ...
        <div style={{
          ...
          background: "radial-gradient(circle, rgba(201,168,92,0.1) 0%, transparent 70%)",
          pointerEvents: "none",
        }} />
      ...
      {/* 그리드 */}
      <section style={{ background: "linear-gradient(180deg, #1a1a1a 0%, #111111 100%)", paddingTop: 60, paddingBottom: 100 }}>
        <div className="container">
          {posts.length === 0 ? (
